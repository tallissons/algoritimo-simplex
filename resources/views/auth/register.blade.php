                          ...
                          <div class="form-group row">
                            <label for="instituicao" class="col-md-4 col-form-label text-md-right">{{ __('Instituição') }}</label>
                                <div class="col-md-6">
                                    <select class="custom-select" id="inputGroupSelect01">
                                    <option selected>Selecione uma Opção</option>
                                    <option value="1">Unimontes</option>
                                    <option value="2">UFMG</option>
                                    <option value="3">Funorte</option>
                                    <option value="4">UniFipMoc</option>
                                    <option value="5">Prominas</option>
                                    <option value="6">IFNMG</option>
                                    <option value="7">Fasa</option>
                                    <option value="8">Santo Agostinho</option>
